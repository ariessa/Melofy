...
class ViewMelody extends StatefulWidget {
  ...
  @override
  _ViewMelodyState createState() => _ViewMelodyState();
}

class _ViewMelodyState extends State<ViewMelody> {
                                  ...
                                  Stack(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Image(
                                              height: SizeConfig.blockSizeVertical * 40,
                                              image: AssetImage('assets/beasty-7aUgMBxhVNU-unsplash.jpg'),
                                              width: double.infinity,
                                              fit: BoxFit.cover
                                            ),
                                      ),
